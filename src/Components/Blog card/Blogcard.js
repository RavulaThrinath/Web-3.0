...
const Blogcard = () => {
  ...
  return (
    <CardContainer className="card-container">
      ...
      An NFT is a digital asset that represents real-world objects like art, music, game items and videos.
      </PostDate>
      <Link className="css-button-rounded" to="/Nft">Read More</Link>
    </CardContainer>
  );
};
